...
15. Kick-off quality (existing bands only): D2 a personal story is not automatically Strong/Elite — score relevance, understanding, resonance, returning focus to the client, and whether it felt natural. If the client begins emotional disclosure and the coach interrupts or redirects before exploring it, do not award Elite rapport or Deep Why. D4 score why identified / stated back / confirmed / North Star / 30-day marker; do not penalize late discovery when the call needed discovery first. D5 naming three phases is not Elite — score job, outcome, analogy, goal tie. D9 the client must understand what, how, where, by when, with verified understanding; equivalent confirmation counts; a scripted repeat-back is not required. D11 a logistics recap ("to recap… upload by Friday…") counts as structured recap for Mid vs Fail; Elite still needs confidence + emotional anchor. D12 score in-call coach promises with timing (e.g. build program over the weekend) — never Fail 0 when a timed deliverable was stated. D7 Elite when channel + response time + community are clear in-call.
